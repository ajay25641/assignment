...
<div class="container mt-4">
    <form action="/Hotel_javaConfig_New_war_exploded/saveHotel" method="post">
    ...
    <div class="text-center">
        <a href="/Hotel_javaConfig_New_war_exploded/home"><button type="button" class="btn btn-primary">Home</button></a>
